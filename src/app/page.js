...
export default function Home() {
  ...
  const TECH_STACK = [
    ...
    {
      category: (<><span>01.03.02 / </span>Backend</>),
      technologies: ["Java", "Spring Boot", "RESTful APIs", "MySQL", "MongoDB", "Servlets & JSP", "Hibernate", "Microservices"]
    },
    {
      category: (<><span>01.03.03 / </span>Tools & Other</>),
      technologies: ["Git", "GitHub", "Maven", "Postman", "Docker", , "JUnit", "VS Code", "Eclipse"]
    },
    {
      category: (<><span>01.03.04 / </span>AI Tools & Models</>),
      technologies: ["Claude Sonnet", "GPT Codex", "Gemini", "GitHub Copilot", "Hugging Face"]
    }
  ]
  ...
  const projects = [
    ...
    },
    {
      ...
      top_info: "Creative Projects",
      name: "ResourceHive",
      page_link: "/projects/resourcehive",
      tech: ["Java 21",
        "Spring Boot",
        "Spring Security",
        "React",
  ...
  // NOTE: Blog entries are commented out for now. When you're ready to add posts,
  // uncomment or add individual objects here with the shape:
  // {
  //   id: "<unique-id>",
  //   name: "<post title>",
  //   platform: "<platform name>",
  //   platform_profile: "<profile url>",
  //   link: "<post url>"
  // }
  // Keeping the example entries below as a reference (commented out):
  /*
  const blogs = [
    // Example placeholder entries — replace these with your real posts when ready.
    {
      id: "example-1",
      name: "Post Title Placeholder",
      platform: "your-blog.com",
      platform_profile: "https://your-blog.com/author",
      link: "https://your-blog.com/example-post"
    },
    {
      id: "example-2",
      name: "Another Post Placeholder",
      platform: "your-blog.com",
      platform_profile: "https://your-blog.com/author",
      link: "https://your-blog.com/another-post"
    }
  ]
  */

  // Currently there are no live blog posts to display. Keep this as an empty
  // array so we can render a friendly placeholder on the page until new posts
  // are added.
  const blogs = [];
  ...
  const SOCIAL_LINKS = [
    {
      href: 'https://www.linkedin.com/in/surya-k28/',
    ...
    {
      href: 'https://github.com/Spicydark',
    ...
    {
      href: 'https://www.instagram.com/itz_su_rya/',
    ...
    {
      href: 'mailto:surya.thenmozhi04@gmail.com',
  ...
  function copyToClipboard() {
    navigator.clipboard
      .writeText('surya.thenmozhi04@gmail.com')
      .then(() => {
        setCopySuccess(true);
      ...
      <main className={HOMECSS.container_main}>
        ...
        <section className={HOMECSS.hero_section} id='home'>
          ...
          <div className={HOMECSS.hero_text}>
            <div className={HOMECSS.intro}>
              <p className={HOMECSS.intro_start}>Hey there! I&apos;m a <strong>Full-Stack Web Developer</strong> passionate about building modern web applications. I specialize in <strong>Java, Spring Boot, and React.js</strong>, focusing on secure, scalable, and high-quality solutions. I'm driven by agile practices , clean code, and a love for creative problem-solving and countless hours spent exploring creative side projects.</p>
            </div>
        ...
        <section className={HOMECSS.about_section} id='about'>
          ...
          <div className={HOMECSS.about_content_hold}>
            <h2>
              I specialize in building <strong>scalable</strong>, <strong>high-performance</strong> web applications with a strong focus on <strong>security</strong>, <strong>efficiency</strong>, and seamless user experiences.
            </h2>
        ...
        <section className={HOMECSS.blogs_section} id="blogs">
          ...
          <div className={HOMECSS.blogs_container}>
            {/*
              Blogs placeholder logic:
              - When `blogs` is empty, show a friendly placeholder message.
              - When posts are added to the `blogs` array, the original map will render them.
            */}
            {blogs.length === 0 ? (
              <div className={HOMECSS.blog_placeholder}>
                <p>Blog posts yet to be added.</p>
                {/* <p className={HOMECSS.blog_placeholder_note}>(Tip: sample entries are kept commented in <code>src/app/page.js</code> for easy copying.)</p> */}
              </div>
            ) : (
        ...
        <section className={HOMECSS.contact_section} id="contact">
            ...
            <ul className={HOMECSS.social_ul}>
              ...
              <li className={HOMECSS.li_gmail}>
                <a className={HOMECSS.gmail} title='Click to Copy Email ID' onClick={copyToClipboard}>
                  <span className={HOMECSS.gmail}>or mail to</span> <span className={HOMECSS.gmail}>surya.thenmozhi04@gmail.com</span>
                </a>
              </li>
            </ul>
          ...
          <div className={HOMECSS.contact_cc}>©&nbsp;2025&nbsp;Surya K</div>
        </section>
      </main>
    </ReactLenis>
  );
